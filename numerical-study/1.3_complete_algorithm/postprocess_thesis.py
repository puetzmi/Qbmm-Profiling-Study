...
def postprocess_thesis(config_module):
    """!
    @brief Main function.
    ...
    ticklabels = list(axs[keys[1]].get_xticks())
    ticklabels[0] = ''
    ticklabels[-1] = ''
    axs[keys[1]].set_xticklabels(ticklabels)

    fig.subplots_adjust(wspace=0, left=0.16, right=0.98)
...
if __name__ == "__main__":
    try:
        ...
        try:
            ...
            raise err
    df = postprocess_thesis(config_module)
